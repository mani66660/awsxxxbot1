...
RUN mv extract /usr/local/bin && \
    ...
    wget -q https://github.com/rootgamer9870-glitch/aria2.conf/raw/master/dht.dat -O /app/dht.dat && \
    wget -q https://github.com/rootgamer9870-glitch/aria2.conf/raw/master/dht6.dat -O /app/dht6.dat && \
    mkdir -p /root/ && \
    mv netrc /root/.netrc && \
